  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900/80">
      <div className="bg-gray-800/95 p-8 rounded-lg shadow-lg text-center">
        ...
        <Link to="/dashboard" className="text-teal-400 hover:text-cyan-300 font-semibold">Go to Dashboard</Link>
      </div>
    </div>
  );
}
...
function NotFound() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900/80">
      <div className="bg-gray-800/95 p-8 rounded-lg shadow-lg text-center">
        <h1 className="text-4xl text-red-400 font-bold mb-4">404 - Page Not Found</h1>
        <p className="text-gray-300 mb-6">Sorry, the page you are looking for does not exist.</p>
        <Link to="/" className="text-teal-400 hover:text-cyan-300 font-semibold">Go Home</Link>
      </div>
    </div>
  );
}
